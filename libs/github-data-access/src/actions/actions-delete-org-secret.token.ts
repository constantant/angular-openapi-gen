...
export const ACTIONS_DELETE_ORG_SECRET = new InjectionToken<
  (org: string, secretName: string) => ReturnType<typeof httpResource<unknown>>
>('ACTIONS_DELETE_ORG_SECRET');

export function provideActionsDeleteOrgSecret(): FactoryProvider {
  return {
    provide: ACTIONS_DELETE_ORG_SECRET,
    useFactory: () => {
