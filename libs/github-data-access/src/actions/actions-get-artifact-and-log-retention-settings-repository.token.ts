...
export function provideActionsGetArtifactAndLogRetentionSettingsRepository(): FactoryProvider {
  return {
    provide: ACTIONS_GET_ARTIFACT_AND_LOG_RETENTION_SETTINGS_REPOSITORY,
    useFactory: () => {
