...
export function provideActionsSetForkPrContributorApprovalPermissionsOrganization(): FactoryProvider {
  return {
    provide: ACTIONS_SET_FORK_PR_CONTRIBUTOR_APPROVAL_PERMISSIONS_ORGANIZATION,
    useFactory: () => {
