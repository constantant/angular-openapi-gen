...
export function provideActionsSetPrivateRepoForkPrWorkflowsSettingsRepository(): FactoryProvider {
  return {
    provide: ACTIONS_SET_PRIVATE_REPO_FORK_PR_WORKFLOWS_SETTINGS_REPOSITORY,
    useFactory: () => {
