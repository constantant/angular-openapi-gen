...
export function provideActionsSetCustomLabelsForSelfHostedRunnerForRepo(): FactoryProvider {
  return {
    provide: ACTIONS_SET_CUSTOM_LABELS_FOR_SELF_HOSTED_RUNNER_FOR_REPO,
    useFactory: () => {
