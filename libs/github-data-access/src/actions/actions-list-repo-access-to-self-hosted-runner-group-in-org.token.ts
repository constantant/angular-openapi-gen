...
export function provideActionsListRepoAccessToSelfHostedRunnerGroupInOrg(): FactoryProvider {
  return {
    provide: ACTIONS_LIST_REPO_ACCESS_TO_SELF_HOSTED_RUNNER_GROUP_IN_ORG,
    useFactory: () => {
