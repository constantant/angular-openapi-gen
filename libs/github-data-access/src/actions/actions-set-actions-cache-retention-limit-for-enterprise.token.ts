...
export function provideActionsSetActionsCacheRetentionLimitForEnterprise(): FactoryProvider {
  return {
    provide: ACTIONS_SET_ACTIONS_CACHE_RETENTION_LIMIT_FOR_ENTERPRISE,
    useFactory: () => {
