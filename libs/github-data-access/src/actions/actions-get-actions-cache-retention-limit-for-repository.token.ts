...
export function provideActionsGetActionsCacheRetentionLimitForRepository(): FactoryProvider {
  return {
    provide: ACTIONS_GET_ACTIONS_CACHE_RETENTION_LIMIT_FOR_REPOSITORY,
    useFactory: () => {
