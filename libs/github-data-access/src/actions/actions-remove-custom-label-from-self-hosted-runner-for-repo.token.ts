...
export function provideActionsRemoveCustomLabelFromSelfHostedRunnerForRepo(): FactoryProvider {
  return {
    provide: ACTIONS_REMOVE_CUSTOM_LABEL_FROM_SELF_HOSTED_RUNNER_FOR_REPO,
    useFactory: () => {
