...
export function provideActionsGetSelfHostedRunnersPermissionsOrganization(): FactoryProvider {
  return {
    provide: ACTIONS_GET_SELF_HOSTED_RUNNERS_PERMISSIONS_ORGANIZATION,
    useFactory: () => {
