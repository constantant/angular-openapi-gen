...
export function provideActionsGetForkPrContributorApprovalPermissionsRepository(): FactoryProvider {
  return {
    provide: ACTIONS_GET_FORK_PR_CONTRIBUTOR_APPROVAL_PERMISSIONS_REPOSITORY,
    useFactory: () => {
