...
export function provideActionsRemoveAllCustomLabelsFromSelfHostedRunnerForOrg(): FactoryProvider {
  return {
    provide: ACTIONS_REMOVE_ALL_CUSTOM_LABELS_FROM_SELF_HOSTED_RUNNER_FOR_ORG,
    useFactory: () => {
