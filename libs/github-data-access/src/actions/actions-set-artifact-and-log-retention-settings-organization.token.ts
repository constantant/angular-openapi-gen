...
export function provideActionsSetArtifactAndLogRetentionSettingsOrganization(): FactoryProvider {
  return {
    provide: ACTIONS_SET_ARTIFACT_AND_LOG_RETENTION_SETTINGS_ORGANIZATION,
    useFactory: () => {
