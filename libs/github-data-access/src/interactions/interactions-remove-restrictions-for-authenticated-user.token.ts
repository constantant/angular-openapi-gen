...
export function provideInteractionsRemoveRestrictionsForAuthenticatedUser(): FactoryProvider {
  return {
    provide: INTERACTIONS_REMOVE_RESTRICTIONS_FOR_AUTHENTICATED_USER,
    useFactory: () => {
