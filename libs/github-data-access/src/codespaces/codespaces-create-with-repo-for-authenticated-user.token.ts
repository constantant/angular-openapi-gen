...
export type CodespacesCreateWithRepoForAuthenticatedUserResponse =
  ...
  | paths['/repos/{owner}/{repo}/codespaces']['post']['responses']['202']['content']['application/json'];
...
export function provideCodespacesCreateWithRepoForAuthenticatedUser(): FactoryProvider {
  return {
    provide: CODESPACES_CREATE_WITH_REPO_FOR_AUTHENTICATED_USER,
    useFactory: () => {
