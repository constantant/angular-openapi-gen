...
export function provideCodespacesAddRepositoryForSecretForAuthenticatedUser(): FactoryProvider {
  return {
    provide: CODESPACES_ADD_REPOSITORY_FOR_SECRET_FOR_AUTHENTICATED_USER,
    useFactory: () => {
