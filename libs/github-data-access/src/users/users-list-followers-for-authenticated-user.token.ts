...
export type UsersListFollowersForAuthenticatedUserError =
  | paths['/user/followers']['get']['responses']['401']['content']['application/json']
  | paths['/user/followers']['get']['responses']['403']['content']['application/json'];
...
function _validateResponse(
  ...
  if (!_result.valid) {
    throw new Error(
      `UsersListFollowersForAuthenticatedUser response failed schema validation: ${JSON.stringify(_result.errors)}`,
    );
  }
  return value as UsersListFollowersForAuthenticatedUserResponse;
}
