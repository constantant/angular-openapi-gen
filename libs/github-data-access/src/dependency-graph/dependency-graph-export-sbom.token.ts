...
export type DependencyGraphExportSbomResponse =
  paths['/repos/{owner}/{repo}/dependency-graph/sbom']['get']['responses']['200']['content']['application/json'];

export const DEPENDENCY_GRAPH_EXPORT_SBOM = new InjectionToken<
  (
    owner: string,
    repo: string,
