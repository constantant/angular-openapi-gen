...
export const TEAMS_REMOVE_MEMBER_LEGACY = new InjectionToken<
  (teamId: string, username: string) => ReturnType<typeof httpResource<unknown>>
>('TEAMS_REMOVE_MEMBER_LEGACY');

export function provideTeamsRemoveMemberLegacy(): FactoryProvider {
  return {
    provide: TEAMS_REMOVE_MEMBER_LEGACY,
    useFactory: () => {
