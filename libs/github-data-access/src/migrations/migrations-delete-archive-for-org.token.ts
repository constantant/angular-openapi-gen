...
export const MIGRATIONS_DELETE_ARCHIVE_FOR_ORG = new InjectionToken<
  (org: string, migrationId: string) => ReturnType<typeof httpResource<unknown>>
>('MIGRATIONS_DELETE_ARCHIVE_FOR_ORG');

export function provideMigrationsDeleteArchiveForOrg(): FactoryProvider {
  return {
    provide: MIGRATIONS_DELETE_ARCHIVE_FOR_ORG,
    useFactory: () => {
