...
export type ReactionsCreateForReleaseResponse =
  ...
  | paths['/repos/{owner}/{repo}/releases/{release_id}/reactions']['post']['responses']['201']['content']['application/json'];
...
export function provideReactionsCreateForRelease(): FactoryProvider {
  return {
    provide: REACTIONS_CREATE_FOR_RELEASE,
    useFactory: () => {
