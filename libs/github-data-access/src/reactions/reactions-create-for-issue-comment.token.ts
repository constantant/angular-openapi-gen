...
export type ReactionsCreateForIssueCommentResponse =
  ...
  | paths['/repos/{owner}/{repo}/issues/comments/{comment_id}/reactions']['post']['responses']['201']['content']['application/json'];
...
export function provideReactionsCreateForIssueComment(): FactoryProvider {
  return {
    provide: REACTIONS_CREATE_FOR_ISSUE_COMMENT,
    useFactory: () => {
