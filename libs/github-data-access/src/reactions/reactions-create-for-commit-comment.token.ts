...
export type ReactionsCreateForCommitCommentResponse =
  ...
  | paths['/repos/{owner}/{repo}/comments/{comment_id}/reactions']['post']['responses']['201']['content']['application/json'];
...
export function provideReactionsCreateForCommitComment(): FactoryProvider {
  return {
    provide: REACTIONS_CREATE_FOR_COMMIT_COMMENT,
    useFactory: () => {
