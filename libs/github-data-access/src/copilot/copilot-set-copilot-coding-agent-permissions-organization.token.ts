...
export function provideCopilotSetCopilotCodingAgentPermissionsOrganization(): FactoryProvider {
  return {
    provide: COPILOT_SET_COPILOT_CODING_AGENT_PERMISSIONS_ORGANIZATION,
    useFactory: () => {
