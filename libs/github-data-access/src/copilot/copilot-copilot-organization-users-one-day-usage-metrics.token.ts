...
export function provideCopilotCopilotOrganizationUsersOneDayUsageMetrics(): FactoryProvider {
  return {
    provide: COPILOT_COPILOT_ORGANIZATION_USERS_ONE_DAY_USAGE_METRICS,
    useFactory: () => {
