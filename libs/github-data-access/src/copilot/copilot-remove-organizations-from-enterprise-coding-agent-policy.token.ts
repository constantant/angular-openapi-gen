...
export function provideCopilotRemoveOrganizationsFromEnterpriseCodingAgentPolicy(): FactoryProvider {
  return {
    provide: COPILOT_REMOVE_ORGANIZATIONS_FROM_ENTERPRISE_CODING_AGENT_POLICY,
    useFactory: () => {
