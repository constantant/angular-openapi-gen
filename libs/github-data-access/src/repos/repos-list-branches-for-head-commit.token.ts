...
type ReposListBranchesForHeadCommitResponse =
...
>('REPOS_LIST_BRANCHES_FOR_HEAD_COMMIT', {
  ...
  factory: () => {
    ...
    return (owner: string, repo: string, commit_sha: string) =>
      httpResource<ReposListBranchesForHeadCommitResponse>(() => ({
        url: `${base}/repos/${owner}/${repo}/commits/${commit_sha}/branches-where-head`,
      }));
  },
});
