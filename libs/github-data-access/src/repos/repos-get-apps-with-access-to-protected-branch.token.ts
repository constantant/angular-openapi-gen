...
export type ReposGetAppsWithAccessToProtectedBranchError =
  paths['/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/apps']['get']['responses']['404']['content']['application/json'];
...
function _validateResponse(
  ...
  if (!_result.valid) {
    throw new Error(
      `ReposGetAppsWithAccessToProtectedBranch response failed schema validation: ${JSON.stringify(_result.errors)}`,
    );
  }
  return value as ReposGetAppsWithAccessToProtectedBranchResponse;
}
