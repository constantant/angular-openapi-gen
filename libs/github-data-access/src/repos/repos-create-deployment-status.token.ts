...
function _validateResponse(
  ...
  if (!_result.valid) {
    throw new Error(
      `ReposCreateDeploymentStatus response failed schema validation: ${JSON.stringify(_result.errors)}`,
    );
  }
  return value as ReposCreateDeploymentStatusResponse;
}
...
export const REPOS_CREATE_DEPLOYMENT_STATUS = new InjectionToken<
  (
    ...
    deploymentId: string,
    body:
      ReposCreateDeploymentStatusBody | Signal<ReposCreateDeploymentStatusBody>,
