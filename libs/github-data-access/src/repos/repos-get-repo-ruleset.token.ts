...
export type ReposGetRepoRulesetError =
  | paths['/repos/{owner}/{repo}/rulesets/{ruleset_id}']['get']['responses']['404']['content']['application/json']
  | paths['/repos/{owner}/{repo}/rulesets/{ruleset_id}']['get']['responses']['500']['content']['application/json'];
...
function _validateResponse(value: unknown): ReposGetRepoRulesetResponse {
  const _result = new Validator(_responseSchema).validate(value);
  if (!_result.valid) {
    throw new Error(
      `ReposGetRepoRuleset response failed schema validation: ${JSON.stringify(_result.errors)}`,
    );
  }
  return value as ReposGetRepoRulesetResponse;
}
...
export const REPOS_GET_REPO_RULESET = new InjectionToken<
  (
    ...
    rulesetId: string,
    params?:
      ReposGetRepoRulesetParams | (() => ReposGetRepoRulesetParams | undefined),
