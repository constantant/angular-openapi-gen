...
export type ReposRemoveUserAccessRestrictionsError =
  paths['/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/users']['delete']['responses']['422']['content']['application/json'];
...
function _validateResponse(
  ...
  if (!_result.valid) {
    throw new Error(
      `ReposRemoveUserAccessRestrictions response failed schema validation: ${JSON.stringify(_result.errors)}`,
    );
  }
  return value as ReposRemoveUserAccessRestrictionsResponse;
}
