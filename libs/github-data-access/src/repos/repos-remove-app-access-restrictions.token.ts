...
export type ReposRemoveAppAccessRestrictionsError =
  paths['/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/apps']['delete']['responses']['422']['content']['application/json'];
...
function _validateResponse(
  ...
  if (!_result.valid) {
    throw new Error(
      `ReposRemoveAppAccessRestrictions response failed schema validation: ${JSON.stringify(_result.errors)}`,
    );
  }
  return value as ReposRemoveAppAccessRestrictionsResponse;
}
