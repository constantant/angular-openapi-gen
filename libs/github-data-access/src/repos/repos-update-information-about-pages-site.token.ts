...
export type ReposUpdateInformationAboutPagesSiteBody = NonNullable<
...
export function provideReposUpdateInformationAboutPagesSite(): FactoryProvider {
  return {
    provide: REPOS_UPDATE_INFORMATION_ABOUT_PAGES_SITE,
    useFactory: () => {
