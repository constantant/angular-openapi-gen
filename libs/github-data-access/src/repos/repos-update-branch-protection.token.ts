...
function _validateResponse(
  ...
  if (!_result.valid) {
    throw new Error(
      `ReposUpdateBranchProtection response failed schema validation: ${JSON.stringify(_result.errors)}`,
    );
  }
  return value as ReposUpdateBranchProtectionResponse;
}
...
export const REPOS_UPDATE_BRANCH_PROTECTION = new InjectionToken<
  (
    ...
    branch: string,
    body:
      ReposUpdateBranchProtectionBody | Signal<ReposUpdateBranchProtectionBody>,
