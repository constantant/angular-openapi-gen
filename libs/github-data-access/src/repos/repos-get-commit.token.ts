...
function _validateResponse(value: unknown): ReposGetCommitResponse {
  const _result = new Validator(_responseSchema).validate(value);
  if (!_result.valid) {
    throw new Error(
      `ReposGetCommit response failed schema validation: ${JSON.stringify(_result.errors)}`,
    );
  }
  return value as ReposGetCommitResponse;
}
  ...
  return {
    ...
    useFactory: () => {
      ...
      return (
        ...
        ref: string,
        params?:
          ReposGetCommitParams | (() => ReposGetCommitParams | undefined),
      ) =>
