...
function _validateResponse(
  ...
  if (!_result.valid) {
    throw new Error(
      `ReposUpdatePullRequestReviewProtection response failed schema validation: ${JSON.stringify(_result.errors)}`,
    );
  }
  return value as ReposUpdatePullRequestReviewProtectionResponse;
}
