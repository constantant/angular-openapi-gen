...
function _validateResponse(
  ...
  if (!_result.valid) {
    throw new Error(
      `ReposCreateForAuthenticatedUser response failed schema validation: ${JSON.stringify(_result.errors)}`,
    );
  }
  return value as ReposCreateForAuthenticatedUserResponse;
}
