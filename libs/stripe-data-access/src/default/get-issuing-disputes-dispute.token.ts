...
export const GET_ISSUING_DISPUTES_DISPUTE = new InjectionToken<
  (
    dispute: string,
    params?:
      | GetIssuingDisputesDisputeParams
      | (() => GetIssuingDisputesDisputeParams | undefined),
  ) => ReturnType<typeof httpResource<GetIssuingDisputesDisputeResponse>>
>('GET_ISSUING_DISPUTES_DISPUTE');

export function provideGetIssuingDisputesDispute(): FactoryProvider {
  return {
    provide: GET_ISSUING_DISPUTES_DISPUTE,
    useFactory: () => {
