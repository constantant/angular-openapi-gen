...
export function provideGetCustomersCustomerBalanceTransactionsTransaction(): FactoryProvider {
  return {
    provide: GET_CUSTOMERS_CUSTOMER_BALANCE_TRANSACTIONS_TRANSACTION,
    useFactory: () => {
