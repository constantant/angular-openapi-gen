...
export type PostTestHelpersIssuingAuthorizationsAuthorizationFraudChallengesRespondBody =
  NonNullable<
...
export function providePostTestHelpersIssuingAuthorizationsAuthorizationFraudChallengesRespond(): FactoryProvider {
  return {
    provide:
      POST_TEST_HELPERS_ISSUING_AUTHORIZATIONS_AUTHORIZATION_FRAUD_CHALLENGES_RESPOND,
    useFactory: () => {
