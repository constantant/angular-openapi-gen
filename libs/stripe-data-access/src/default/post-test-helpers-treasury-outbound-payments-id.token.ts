...
export type PostTestHelpersTreasuryOutboundPaymentsIdBody = NonNullable<
...
export function providePostTestHelpersTreasuryOutboundPaymentsId(): FactoryProvider {
  return {
    provide: POST_TEST_HELPERS_TREASURY_OUTBOUND_PAYMENTS_ID,
    useFactory: () => {
