...
export type DeleteTerminalReadersReaderBody = NonNullable<
...
export function provideDeleteTerminalReadersReader(): FactoryProvider {
  return {
    provide: DELETE_TERMINAL_READERS_READER,
    useFactory: () => {
