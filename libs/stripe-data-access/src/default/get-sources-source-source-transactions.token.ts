...
export type GetSourcesSourceSourceTransactionsParams =
...
export const GET_SOURCES_SOURCE_SOURCE_TRANSACTIONS = new InjectionToken<
  (
    source: string,
    params?:
      | GetSourcesSourceSourceTransactionsParams
      | (() => GetSourcesSourceSourceTransactionsParams | undefined),
  ) => ReturnType<
    typeof httpResource<GetSourcesSourceSourceTransactionsResponse>
  >
>('GET_SOURCES_SOURCE_SOURCE_TRANSACTIONS');

export function provideGetSourcesSourceSourceTransactions(): FactoryProvider {
  return {
    provide: GET_SOURCES_SOURCE_SOURCE_TRANSACTIONS,
    useFactory: () => {
