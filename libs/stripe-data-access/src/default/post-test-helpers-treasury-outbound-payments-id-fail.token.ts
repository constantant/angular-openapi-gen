...
export type PostTestHelpersTreasuryOutboundPaymentsIdFailBody = NonNullable<
...
export function providePostTestHelpersTreasuryOutboundPaymentsIdFail(): FactoryProvider {
  return {
    provide: POST_TEST_HELPERS_TREASURY_OUTBOUND_PAYMENTS_ID_FAIL,
    useFactory: () => {
