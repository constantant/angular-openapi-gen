...
export type PostPaymentIntentsIntentApplyCustomerBalanceBody = NonNullable<
...
export function providePostPaymentIntentsIntentApplyCustomerBalance(): FactoryProvider {
  return {
    provide: POST_PAYMENT_INTENTS_INTENT_APPLY_CUSTOMER_BALANCE,
    useFactory: () => {
