...
export type PostChargesChargeRefundsRefundBody = NonNullable<
...
export function providePostChargesChargeRefundsRefund(): FactoryProvider {
  return {
    provide: POST_CHARGES_CHARGE_REFUNDS_REFUND,
    useFactory: () => {
