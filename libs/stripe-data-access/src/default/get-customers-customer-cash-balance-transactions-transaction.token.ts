...
export function provideGetCustomersCustomerCashBalanceTransactionsTransaction(): FactoryProvider {
  return {
    provide: GET_CUSTOMERS_CUSTOMER_CASH_BALANCE_TRANSACTIONS_TRANSACTION,
    useFactory: () => {
