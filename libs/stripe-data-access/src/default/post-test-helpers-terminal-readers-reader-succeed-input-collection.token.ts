...
export function providePostTestHelpersTerminalReadersReaderSucceedInputCollection(): FactoryProvider {
  return {
    provide: POST_TEST_HELPERS_TERMINAL_READERS_READER_SUCCEED_INPUT_COLLECTION,
    useFactory: () => {
