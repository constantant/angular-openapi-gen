...
export type PostPaymentMethodConfigurationsBody = NonNullable<
...
export function providePostPaymentMethodConfigurations(): FactoryProvider {
  return {
    provide: POST_PAYMENT_METHOD_CONFIGURATIONS,
    useFactory: () => {
