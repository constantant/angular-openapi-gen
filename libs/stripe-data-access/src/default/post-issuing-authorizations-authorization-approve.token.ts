...
export type PostIssuingAuthorizationsAuthorizationApproveBody = NonNullable<
...
export function providePostIssuingAuthorizationsAuthorizationApprove(): FactoryProvider {
  return {
    provide: POST_ISSUING_AUTHORIZATIONS_AUTHORIZATION_APPROVE,
    useFactory: () => {
