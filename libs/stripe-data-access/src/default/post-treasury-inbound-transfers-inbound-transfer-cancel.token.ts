...
export function providePostTreasuryInboundTransfersInboundTransferCancel(): FactoryProvider {
  return {
    provide: POST_TREASURY_INBOUND_TRANSFERS_INBOUND_TRANSFER_CANCEL,
    useFactory: () => {
