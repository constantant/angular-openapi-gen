...
export function providePostPaymentRecordsIdReportPaymentAttemptGuaranteed(): FactoryProvider {
  return {
    provide: POST_PAYMENT_RECORDS_ID_REPORT_PAYMENT_ATTEMPT_GUARANTEED,
    useFactory: () => {
