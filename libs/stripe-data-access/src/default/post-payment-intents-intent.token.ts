...
export type PostPaymentIntentsIntentBody = NonNullable<
...
export function providePostPaymentIntentsIntent(): FactoryProvider {
  return {
    provide: POST_PAYMENT_INTENTS_INTENT,
    useFactory: () => {
      ...
      return (
        ...
        body:
          ...
          | Signal<PostPaymentIntentsIntentBody>,
      ) =>
