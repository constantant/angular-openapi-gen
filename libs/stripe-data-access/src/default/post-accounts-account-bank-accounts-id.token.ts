...
export type PostAccountsAccountBankAccountsIdBody = NonNullable<
...
export function providePostAccountsAccountBankAccountsId(): FactoryProvider {
  return {
    provide: POST_ACCOUNTS_ACCOUNT_BANK_ACCOUNTS_ID,
    useFactory: () => {
