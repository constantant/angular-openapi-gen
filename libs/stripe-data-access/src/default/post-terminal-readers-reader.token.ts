...
export type PostTerminalReadersReaderBody = NonNullable<
...
export function providePostTerminalReadersReader(): FactoryProvider {
  return {
    provide: POST_TERMINAL_READERS_READER,
    useFactory: () => {
