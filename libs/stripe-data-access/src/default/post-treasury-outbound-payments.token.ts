...
export type PostTreasuryOutboundPaymentsBody = NonNullable<
...
export function providePostTreasuryOutboundPayments(): FactoryProvider {
  return {
    provide: POST_TREASURY_OUTBOUND_PAYMENTS,
    useFactory: () => {
